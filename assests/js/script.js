...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | Devdeepsinh Jadeja";
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["front end development", "React Node Development", " Django development", "Cyber Security"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
...
var Tawk_API=Tawk_API||{}, Tawk_LoadStart=new Date();
  ...
  s1.async=true;
  s1.src='https://embed.tawk.to/61c5668ec82c976b71c34d09/1fnlhh7p9';
  s1.charset='UTF-8';
